...
//   @override
//   State<DetalleHabitacionScreen> createState() => _DetalleHabitacionScreenState();
// }
...
//   // NUEVO MÉTODO PARA MOSTRAR MODAL DE RESEÑAS
...
//                         const SizedBox(height: 20),
//                         // BOTONES ORIGINALES (RESERVA Y CITA)
//                         Row(
//                           children: [
//                             Expanded(
...
//                           ],
//                         ),
//                         // NUEVO: BOTÓN DE RESEÑAS (DEBAJO DE LOS ANTERIORES)
...
//   // ... (el resto del código se mantiene igual, no lo modifiques)
//   Widget _buildUbicacion() {
//     final hasGoogleMaps = widget.habitacion['googleMaps'] != null && 
...
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: [
//               _buildUbicacionItem('🏙️ Zona', widget.habitacion['zona'] ?? 'No especificada'),
//               const SizedBox(height: 12),
//               _buildUbicacionItem('🏠 Dirección', widget.habitacion['direccion'] ?? 'No especificada'),
//               const SizedBox(height: 16),
//               if (hasGoogleMaps)
//                 Container(
//                   height: 50,
...
//                       mainAxisAlignment: MainAxisAlignment.center,
//                       children: [
//                         Icon(Icons.map_outlined, size: 20, color: Colors.blue[700]),
//                         const SizedBox(width: 8),
//                         const Text(
//                           'Ver en Google Maps',
//                           style: TextStyle(
...
//           child: Column(
//             children: [
//               _buildDetalleItem('👥 Capacidad', '${widget.habitacion['capacidad']} personas'),
//               const SizedBox(height: 12),
//               _buildDetalleItem('📅 Duración', '${widget.habitacion['duracionRutas']} meses'),
//               const SizedBox(height: 12),
//               _buildDetalleItem('🏠 Tipo', _getTipoCompleto(widget.habitacion)),
//               const SizedBox(height: 12),
//               _buildDetalleItem('📍 Dirección', widget.habitacion['direccion'] ?? 'No especificada'),
//             ],
//           ),
//         ),
//         const SizedBox(height: 16),
...
//                   children: [
//                     Text(
//                       widget.habitacion['nombreArrendador'] ?? 'No especificado',
//                       style: const TextStyle(
//                         fontSize: 18,
//                         fontWeight: FontWeight.bold,
//                         color: Colors.purple,
...
//     final tipo = habitacion['tipo']?.toString().toLowerCase() ?? 'individual';
//     return tipo == 'individual' ? 'Habitación Individual' : 'Habitación Compartida';
//   }
// }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Container(
              ...
              child: Icon(
                Icons.home_work, // Icono de casa que representa la habitación
                color: Colors.white,
                size: 20,
              ),
            ),
        ...
        backgroundColor: Colors.green[700], // Mismo color verde que las otras
        foregroundColor: Colors.white,
        elevation: 4,
        ...
        // ELIMINADO: El botón de compartir que estaba aquí
      ),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(12),
        child: Column(
