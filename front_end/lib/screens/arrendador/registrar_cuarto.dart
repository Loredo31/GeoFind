...
//           setState(() {
//             _fotografiasBase64.add(base64Image);
//           });
...
//       }
//     } catch (error) {
//       _mostrarError('Error al seleccionar imagen: $error');
//       // Fallback: Permitir subir archivos de forma nativa en web
//       if (kIsWeb) {
//         _seleccionarFotoWeb();
//       }
//     }
...
//   // Método alternativo para web
//   void _seleccionarFotoWeb() {
//     _mostrarMensaje('Para subir imágenes en la web, usa el botón de "Seleccionar archivos" del navegador');
//   }
...
//     // Validar que al menos hay una foto
...
//         'capacidad': _tipoSeleccionado == 'compartido' ? int.parse(_capacidadController.text) : 1,
...
//                           Text(
//                             'Agrega fotos que muestren la habitación desde diferentes ángulos',
//                             style: TextStyle(
//                               fontSize: 12,
