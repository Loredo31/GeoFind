...
//   //   try {
//   //     // Cargar citas pendientes del arrendador
//   //     final citasResponse = await CitaService.obtenerCitasArrendador(widget.usuario.id);
//   //     final reservasResponse = await ReservarCuartoService.obtenerReservasArrendador(widget.usuario.id!);

//   //     if (citasResponse['success'] == true && reservasResponse['success'] == true) {
//   //       setState(() {
//   //         _solicitudesCitas = (citasResponse['data'] ?? []).where((cita) => cita['estado'] == null).toList();
//   //         _solicitudesReservas = (reservasResponse['data'] ?? []).where((reserva) => reserva['estado'] == false).toList();
...
//  Future<void> _cargarNotificaciones() async {
//   try {
//     // PRIMERO: Obtener todas las habitaciones del arrendador
...
//       // PARA CADA HABITACIÓN, obtener sus citas y reservas
//       for (var habitacion in habitaciones) {
//         final String habitacionId = habitacion['_id'];
        
//         // Obtener citas de esta habitación
...
//         // Obtener reservas de esta habitación
...
//       setState(() {
//         // Filtrar solo las solicitudes con estado NULL (pendientes)
...
//       _cargarNotificaciones();
//       Navigator.pop(context); // Cerrar el modal de info si está abierto
//     } catch (error) {
...
//     // Para el rechazo, podríamos pedir un motivo
