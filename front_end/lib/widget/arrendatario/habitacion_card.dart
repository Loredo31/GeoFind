...
// widgets/habitacion_card.dart (ACTUALIZADO)
import 'package:flutter/material.dart';
...
class HabitacionCard extends StatelessWidget {
  ...
  RoomTheme get _theme {
    final themeName = habitacion['diseño'] ?? 'estandar';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Icon(
                                _theme.mainIcon, // ✅ Icono dinámico según tema
                                size: 12,
                                color: _theme.textColor.withOpacity(0.7),
                              ),
                              const SizedBox(width: 2),
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        Icons.star_border,
                        color: _theme.primaryColor, // ✅ Color dinámico
                        size: 18,
                      ),
                    ),
                  ),
  ...
  Widget _buildLoadingImage() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: _theme.backgroundColor, // ✅ Color dinámico
      ),
      child: Center(
        child: CircularProgressIndicator(
          valueColor: AlwaysStoppedAnimation<Color>(_theme.primaryColor), // ✅ Color dinámico
        ),
      ),
    );
  }
    ...
    return Container(
      ...
      child: Stack(
        children: [
          Center(
            child: Icon(
              _theme.mainIcon, // ✅ Icono dinámico
              size: 40, 
              color: _theme.primaryColor.withOpacity(0.3), // ✅ Color dinámico
            ),
          ),
          Positioned(
            top: 6,
